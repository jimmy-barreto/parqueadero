  ...
  <div class="row align-items-center">
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3" *style="background:black">
          <div class="card-header card-header-primary text-center" *style="background:red">
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Inicie Sesión y Disfrute de la Aplicación.') }}</p>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Inicie Sesión') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
